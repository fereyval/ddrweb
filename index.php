	...
	<div class="conteneur center">
		<div class="row pts pll">
			...
			<img src="styles/qui.png" class="left" style="margin-top: 20px; margin-bottom: 0px;">
                ...
                <div class="plm">	
                    ...
                    <p style="margin-top: 0px;">
                    Je code depuis pr�s de 3 ans et ai appris les bases du Web gr�ce � l'association Epiweb Lyon et me suis form� durant un stage de 4 mois chez Pixellweb une entreprise �galement bas�e sur la conception de sites internet aux Antilles. Pour en savoir plus sur mes comp�tences, cliquez sur le lien ci-dessous.
                    </p>
                </div>
		...
		<div class="pll ptm pbm">
			...
			<div class="box5">
				...
				<p style="margin-top: 0px;">La formule basique � petits prix et tr�s rapide!</p>
				</div>
			</div>
			<div class="box5">
				...
				<div class="left w90">
					...
					<p style="margin-top: 0px;">La formule all inclusive, pour cr�er un site � votre image dans un d�lais impos�.</p>
				</div>
			</div>
			<div class="box5">
		...
		<div class="plm mts">
			<h2 class="pls title-h2 txtcenter" id="rea"><span>Mes derni�res</span> r�alisations</h2>
			<div id="carousel">
