            ...
            appendHTML: function() {
                if($(object).is('img')) {
                    ...
                    if(settings.animateIn) {    
                        var icon = '<span class="icon" style="background:url('+settings.icon+') center center no-repeat"></span>';
                        $(object).wrap('<div class="slickhoverWrapper" style="background:'+settings.color+';"></div>');
                        $(icon).insertBefore($(object));
                    }
                    else
                        $(object).wrap('<div class="slickhoverWrapper" style="background:url('+settings.icon+') center center no-repeat '+settings.color+';"></div>');        
                }
            },
